...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("-----------------------");
            Console.WriteLine("Only Four Ascending: ");
            ...
            numbers[4] = 20;
            Console.WriteLine("-----------------------");
            Console.WriteLine("Age and then Descending: ");
            ...
            Console.WriteLine("-----------------------");
            Console.WriteLine("Employee List (C & S):  ");
            ...
            var oldishPeople = employees.Where(emp => emp.Age > 26).OrderBy(emp => emp.Age).ThenBy(emp => emp.FirstName);

            Console.WriteLine("-----------------------");
            Console.WriteLine("26 and over:  ");
            foreach (var person in oldishPeople)
            {
            ...
            employees = employees.Append(new Employee("Tiago", "Gomes", 20, 1)).ToList();
